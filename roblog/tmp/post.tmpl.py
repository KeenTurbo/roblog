...
_magic_number = 8
_modified_time = 1340130904.108848
_enable_loop = True
_template_filename = 'themes/roblog_theme/templates/post.tmpl'
...
def render_content(context,**pageargs):
    ...
    try:
        ...
        if post.prev_post:
            ...
            # SOURCE LINE 32
            __M_writer(unicode(rel_link(permalink, post.prev_post.permalink(lang))))
            __M_writer(u'">')
        ...
        if post.next_post:
            ...
            # SOURCE LINE 37
            __M_writer(unicode(rel_link(permalink, post.next_post.permalink(lang))))
            __M_writer(u'">')
