...
_magic_number = 8
_modified_time = 1340125212.406476
_enable_loop = True
_template_filename = '/home/robertfw/code/personal/blog/venv/lib/python2.7/site-packages/nikola/data/themes/default/templates/index.tmpl'
...
def render_content(context,**pageargs):
    ...
    try:
        ...
        for post in posts:
            ...
            # SOURCE LINE 6
            __M_writer(unicode(rel_link(permalink, post.permalink(lang))))
            __M_writer(u'">')
