...
_magic_number = 8
_modified_time = 1340130704.334063
_enable_loop = True
_template_filename = u'themes/roblog_theme/templates/base.tmpl'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'</title>\n    <!-- Le styles -->\n    <link href="')
        # SOURCE LINE 8
        __M_writer(unicode(rel_link(permalink, "/assets/css/bootstrap.css")))
        __M_writer(u'" rel="stylesheet" type="text/css">\n    <link href="')
        # SOURCE LINE 9
        __M_writer(unicode(rel_link(permalink, "/assets/css/bootstrap-responsive.css")))
        __M_writer(u'" rel="stylesheet" type="text/css">\n    <link href="')
        # SOURCE LINE 10
        __M_writer(unicode(rel_link(permalink, "/assets/css/rst.css")))
        __M_writer(u'" rel="stylesheet" type="text/css">\n    <link href="')
        # SOURCE LINE 11
        __M_writer(unicode(rel_link(permalink, "/assets/css/code.css")))
        __M_writer(u'" rel="stylesheet" type="text/css">\n')
        # SOURCE LINE 12
        if exists("files/assets/css/custom.css", not_empty=True):
            # SOURCE LINE 13
            __M_writer(u'    <link href="')
            __M_writer(unicode(rel_link(permalink, "/assets/css/custom.css")))
            __M_writer(u'" rel="stylesheet"  type="text/css">\n')
            pass
        # SOURCE LINE 15
